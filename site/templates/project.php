...
<main class="project-layout main">
    ...
    <section class="info">
        <div class="info-wrapper">
            <button class="button info-close-button" type="button">
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="button-wrapper">
        <div class="info-preview-wrapper">
            <button class="button info-open-button" type="button">
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="info-preview">
                ...
                <button class="button info-preview-button" type="button">
                    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="0.5" y="0.5" width="39" height="39" fill="#1d1d1b"/>
