<?php
    if ($pages->template('project')) {
        $gallery = $page->gallery()->toFiles();
    } 
    
    if ($pages->template('tool')) {
        $gallery = $pages->files()->filterBy('tools', '*=', $page->title());
    }
?>
        ...
        <div class="gallery-grid">
            <?php foreach ($gallery as $media) : ?>
                <?php if ($media->type() == 'image') : ?>
                    <figure class="gallery-item image-item" data-filterseta="<?= $media->filterSetA() ?>" data-filtersetb="<?= $media->filterSetB() ?>" data-tools="<?= $media->tools() ?>">
                ...
                <?php if ($media->type() == 'video') : ?>
                    <figure class="gallery-item video-item" data-filterseta="<?= $media->filterSetA() ?>" data-filtersetb="<?= $media->filterSetB() ?>" data-tools="<?= $media->tools() ?>">
                ...
                <?php if ($media->type() == 'audio') : ?>
                    <figure class="gallery-item audio-item" data-filterseta="<?= $media->filterSetA() ?>" data-filtersetb="<?= $media->filterSetB() ?>" data-tools="<?= $media->tools() ?>">
